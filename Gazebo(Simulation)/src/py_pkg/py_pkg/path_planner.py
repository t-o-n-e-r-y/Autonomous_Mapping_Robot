...
class PathPlanner:
    ...
    def calc_cost_map(mapdata: OccupancyGrid) -> np.ndarray:
        ...
        Unknown cells are treated as free for planning.
        """
        width = mapdata.info.width
        height = mapdata.info.height
        ...
        # Chỉ obstacle thật mới là blocked.
        # Vì cspace đã biến obstacle/dilated obstacle thành > 0.
        # Unknown không còn là -1 trong cspace nếu calc_cspace đã sửa như trên.
        blocked = map_array > 0
